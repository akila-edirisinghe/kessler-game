...
ex_adv_four_corners_pt0 = Scenario(
    name='ex_adv_four_corners_pt0',
    asteroid_states=[
        {'position': (pad, pad), 'angle': 0.0, 'speed': 100, 'size': 4},
        
    ],
    ship_states=[{'position': (width-pad+350, pad+100), 'lives': 3, 'angle': 0, 'team': 1, 'mines_remaining': 3},
